var Views = (function(){
	...
	var NewSearchView = Backbone.View.extend({
		render : function () {
			...
			var cityInput = '<input id="city" type="text" class="form-group" placeholder="City or zip code" aria-describedby="sizing-addon1"></div>';
			var buttonSearch = '<button id="buttonSearch"><i class="fa fa-search" ></i></button>';
